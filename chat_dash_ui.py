...
class CalmsDashApp:
    def __init__(self, title="LLMicroscopy", favicon="aps_logo.png") -> None:
        # Set up app
    ...
    def assign_layout(
        ...
        logo_height="60px",
        app_title="LLMicroscopy | X-ray Science Division",
    ):
    ...
    def setup_app(
        self, title="LLMicroscopy", favicon="LBL_icon.png",
    ):
        #### SETUP DASH APP ####
