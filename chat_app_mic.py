...
import xray_mic_tools, electron_mic_tools, llms
...
class ToolChat(Chat):
    ...
    def _init_chain(self):
        """
        tools = [
            xray_mic_tools.MicroscopeInfo(params.spec_init)   
        ]
        """

        tools = [xray_mic_tools.info_tool, electron_mic_tools.probe_sim_tool, electron_mic_tools.virtual_imaging_tool]
