...
from callback.chat_prompt import update_chat
from llm_init import get_llm, get_embeddings
from Chat import Chat, ToolChat
...
class CalmsDashApp:
    def __init__(self, title="LLMicroscopy", favicon="llm_logo.png") -> None:
        ...
        self.chat = Chat(self.llm, self.embeddings, doc_store=None)
        update_chat(self.app, self.chat)
